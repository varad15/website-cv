  ...
  return (
    ...
    >
      ...
      {skillsData[0].skills.map((skill, index) => (
        <div
          key={index}
          className={`skill-item cursor-pointer flex flex-col gap-4 rounded-2xl p-8 border-solid border-[0.25rem] items-center justify-center ${
        ...
        >
          ...
          />
          <h3 className="text-2xl font-semibold text-center mt-2 max-lg:text-xl">
            {skill.title}
          </h3>
        </div>
      ))}
